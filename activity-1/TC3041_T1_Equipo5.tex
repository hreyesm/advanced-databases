...
Un aspecto importante que logra observarse, es que las operaciones de inserción son por mucho, más costosas que las operaciones de consulta.

Dicho esto, los resultados obtenidos indican que, conforme crece el tamaño de la población, tanto el tiempo de inserción como el de las consultas aumenta. Esto puede verse con mayor claridad en las operaciones de inserción y en las consultas por filtrado, donde los tiempos ejecución aumentaron de manera exponencial con relación al número de registros almacenados en la tabla.

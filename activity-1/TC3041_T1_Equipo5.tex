...
\begin{figure}[ht]
  \includegraphics[width=75mm, scale=0.5]{./images/storage-tiers.jpg}
...
Kinetica cuenta con un {\itshape streaming data warehouse}, el cual, a diferencia de los {\itshape data warehouses} tradicionales, puede analizar los datos almacenados en tiempo real. De este modo, se obtiene un anáisis que puede ser utilizado de manera innmediata [1].

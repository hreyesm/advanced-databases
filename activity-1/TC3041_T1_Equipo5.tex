...
Aquí van los resultados chidos
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=75mm, scale=0.5]{./images/query-select.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=75mm, scale=0.5]{./images/query-aggregation.png}
  ...
  \label{fig:Consulta con funciones de agregación y agrupamiento}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=75mm, scale=0.5]{./images/query-where.png}
